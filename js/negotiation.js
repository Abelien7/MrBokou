...
const Nego = (() => {
  ...
  // Redimensionne (max 1280px de côté) et recompresse en JPEG ~75% avant
  // l'envoi : les photos de chantier prises au téléphone pèsent souvent
  // plusieurs Mo, inutile sur un forfait data togolais.
